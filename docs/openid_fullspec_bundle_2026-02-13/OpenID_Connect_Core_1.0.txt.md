...
Table of Contents
   ...
   2.  ID Token  . . . . . . . . . . . . . . . . . . . . . . . . . .  14
   3.  Authentication  . . . . . . . . . . . . . . . . . . . . . . .  18
     3.1.   Authentication using the Authorization Code Flow . . . .  19
       3.1.1.  Authorization Code Flow Steps . . . . . . . . . . . .  20
       3.1.2.  Authorization Endpoint  . . . . . . . . . . . . . . .  20
         3.1.2.1.  Authentication Request  . . . . . . . . . . . . .  20
         3.1.2.2.  Authentication Request Validation . . . . . . . .  26
         3.1.2.3.  Authorization Server Authenticates End-User . . .  27
         3.1.2.4.  Authorization Server Obtains End-User
                   Consent/Authorization . . . . . . . . . . . . . .  27
         3.1.2.5.  Successful Authentication Response  . . . . . . .  28
         3.1.2.6.  Authentication Error Response . . . . . . . . . .  28
         3.1.2.7.  Authentication Response Validation  . . . . . . .  30
       3.1.3.  Token Endpoint  . . . . . . . . . . . . . . . . . . .  31
         3.1.3.1.  Token Request . . . . . . . . . . . . . . . . . .  31
         3.1.3.2.  Token Request Validation  . . . . . . . . . . . .  31
         3.1.3.3.  Successful Token Response . . . . . . . . . . . .  32
         3.1.3.4.  Token Error Response  . . . . . . . . . . . . . .  33
         3.1.3.5.  Token Response Validation . . . . . . . . . . . .  34
         3.1.3.6.  ID Token  . . . . . . . . . . . . . . . . . . . .  34
         3.1.3.7.  ID Token Validation . . . . . . . . . . . . . . .  34
         3.1.3.8.  Access Token Validation . . . . . . . . . . . . .  36
     3.2.   Authentication using the Implicit Flow . . . . . . . . .  36
       3.2.1.  Implicit Flow Steps . . . . . . . . . . . . . . . . .  36
       3.2.2.  Authorization Endpoint  . . . . . . . . . . . . . . .  37
         3.2.2.1.  Authentication Request  . . . . . . . . . . . . .  37
         3.2.2.2.  Authentication Request Validation . . . . . . . .  38
         3.2.2.3.  Authorization Server Authenticates End-User . . .  38
         3.2.2.4.  Authorization Server Obtains End-User
                   Consent/Authorization . . . . . . . . . . . . . .  38
         3.2.2.5.  Successful Authentication Response  . . . . . . .  38
         3.2.2.6.  Authentication Error Response . . . . . . . . . .  39
         3.2.2.7.  Redirect URI Fragment Handling  . . . . . . . . .  40
         3.2.2.8.  Authentication Response Validation  . . . . . . .  40
         3.2.2.9.  Access Token Validation . . . . . . . . . . . . .  40
         3.2.2.10. ID Token  . . . . . . . . . . . . . . . . . . . .  41
         3.2.2.11. ID Token Validation . . . . . . . . . . . . . . .  41
     3.3.   Authentication using the Hybrid Flow . . . . . . . . . .  41
       3.3.1.  Hybrid Flow Steps . . . . . . . . . . . . . . . . . .  42
       3.3.2.  Authorization Endpoint  . . . . . . . . . . . . . . .  42
         3.3.2.1.  Authentication Request  . . . . . . . . . . . . .  42
         3.3.2.2.  Authentication Request Validation . . . . . . . .  43
...

         ...
         3.3.2.3.  Authorization Server Authenticates End-User . . .  43
         3.3.2.4.  Authorization Server Obtains End-User
                   Consent/Authorization . . . . . . . . . . . . . .  43
         3.3.2.5.  Successful Authentication Response  . . . . . . .  44
         3.3.2.6.  Authentication Error Response . . . . . . . . . .  44
         3.3.2.7.  Redirect URI Fragment Handling  . . . . . . . . .  45
         3.3.2.8.  Authentication Response Validation  . . . . . . .  45
         3.3.2.9.  Access Token Validation . . . . . . . . . . . . .  45
         3.3.2.10. Authorization Code Validation . . . . . . . . . .  45
         3.3.2.11. ID Token  . . . . . . . . . . . . . . . . . . . .  46
         3.3.2.12. ID Token Validation . . . . . . . . . . . . . . .  47
       3.3.3.  Token Endpoint  . . . . . . . . . . . . . . . . . . .  47
         3.3.3.1.  Token Request . . . . . . . . . . . . . . . . . .  47
         3.3.3.2.  Token Request Validation  . . . . . . . . . . . .  47
         3.3.3.3.  Successful Token Response . . . . . . . . . . . .  47
         3.3.3.4.  Token Error Response  . . . . . . . . . . . . . .  47
         3.3.3.5.  Token Response Validation . . . . . . . . . . . .  47
         3.3.3.6.  ID Token  . . . . . . . . . . . . . . . . . . . .  47
         3.3.3.7.  ID Token Validation . . . . . . . . . . . . . . .  48
         3.3.3.8.  Access Token  . . . . . . . . . . . . . . . . . .  48
         3.3.3.9.  Access Token Validation . . . . . . . . . . . . .  48
   4.  Initiating Login from a Third Party . . . . . . . . . . . . .  49
   5.  Claims  . . . . . . . . . . . . . . . . . . . . . . . . . . .  51
     5.1.   Standard Claims  . . . . . . . . . . . . . . . . . . . .  51
       5.1.1.  Address Claim . . . . . . . . . . . . . . . . . . . .  56
       5.1.2.  Additional Claims . . . . . . . . . . . . . . . . . .  57
     5.2.   Claims Languages and Scripts . . . . . . . . . . . . . .  58
     5.3.   UserInfo Endpoint  . . . . . . . . . . . . . . . . . . .  59
       5.3.1.  UserInfo Request  . . . . . . . . . . . . . . . . . .  59
       5.3.2.  Successful UserInfo Response  . . . . . . . . . . . .  60
       5.3.3.  UserInfo Error Response . . . . . . . . . . . . . . .  61
       5.3.4.  UserInfo Response Validation  . . . . . . . . . . . .  61
     5.4.   Requesting Claims using Scope Values . . . . . . . . . .  61
     5.5.   Requesting Claims using the "claims" Request Parameter .  63
       5.5.1.  Individual Claims Requests  . . . . . . . . . . . . .  64
         5.5.1.1.  Requesting the "acr" Claim  . . . . . . . . . . .  67
       5.5.2.  Languages and Scripts for Individual Claims . . . . .  67
     5.6.   Claim Types  . . . . . . . . . . . . . . . . . . . . . .  68
       5.6.1.  Normal Claims . . . . . . . . . . . . . . . . . . . .  68
       5.6.2.  Aggregated and Distributed Claims . . . . . . . . . .  69
         5.6.2.1.  Example of Aggregated Claims  . . . . . . . . . .  70
         5.6.2.2.  Example of Distributed Claims . . . . . . . . . .  71
     5.7.   Claim Stability and Uniqueness . . . . . . . . . . . . .  72
   6.  Passing Request Parameters as JWTs  . . . . . . . . . . . . .  74
     6.1.   Passing a Request Object by Value  . . . . . . . . . . .  74
       6.1.1.  Request using the "request" Request Parameter . . . .  77
     6.2.   Passing a Request Object by Reference  . . . . . . . . .  78
       6.2.1.  URI Referencing the Request Object  . . . . . . . . .  80
...

       ...
       6.2.2.  Request using the "request_uri" Request Parameter . .  80
       6.2.3.  Authorization Server Fetches Request Object . . . . .  81
       6.2.4.  "request_uri" Rationale . . . . . . . . . . . . . . .  81
     6.3.   Validating JWT-Based Requests  . . . . . . . . . . . . .  82
       6.3.1.  Encrypted Request Object  . . . . . . . . . . . . . .  82
       6.3.2.  Signed Request Object . . . . . . . . . . . . . . . .  82
       6.3.3.  Request Parameter Assembly and Validation . . . . . .  82
   7.  Self-Issued OpenID Provider . . . . . . . . . . . . . . . . .  84
     7.1.   Self-Issued OpenID Provider Discovery  . . . . . . . . .  84
     7.2.   Self-Issued OpenID Provider Registration . . . . . . . .  84
       7.2.1.  Providing Information with the "registration"
               Request Parameter . . . . . . . . . . . . . . . . . .  85
     7.3.   Self-Issued OpenID Provider Request  . . . . . . . . . .  86
     7.4.   Self-Issued OpenID Provider Response . . . . . . . . . .  87
     7.5.   Self-Issued ID Token Validation  . . . . . . . . . . . .  88
   8.  Subject Identifier Types  . . . . . . . . . . . . . . . . . .  90
     8.1.   Pairwise Identifier Algorithm  . . . . . . . . . . . . .  90
   9.  Client Authentication . . . . . . . . . . . . . . . . . . . .  92
   10. Signatures and Encryption . . . . . . . . . . . . . . . . . .  96
     10.1.  Signing  . . . . . . . . . . . . . . . . . . . . . . . .  96
       10.1.1. Rotation of Asymmetric Signing Keys . . . . . . . . .  97
     10.2.  Encryption . . . . . . . . . . . . . . . . . . . . . . .  97
       10.2.1. Rotation of Asymmetric Encryption Keys  . . . . . . .  98
   11. Offline Access  . . . . . . . . . . . . . . . . . . . . . . .  99
   12. Using Refresh Tokens  . . . . . . . . . . . . . . . . . . . . 100
     12.1.  Refresh Request  . . . . . . . . . . . . . . . . . . . . 100
     12.2.  Successful Refresh Response  . . . . . . . . . . . . . . 100
     12.3.  Refresh Error Response . . . . . . . . . . . . . . . . . 101
   13. Serializations  . . . . . . . . . . . . . . . . . . . . . . . 102
     13.1.  Query String Serialization . . . . . . . . . . . . . . . 102
     13.2.  Form Serialization . . . . . . . . . . . . . . . . . . . 102
     13.3.  JSON Serialization . . . . . . . . . . . . . . . . . . . 103
   14. String Operations . . . . . . . . . . . . . . . . . . . . . . 104
   15. Implementation Considerations . . . . . . . . . . . . . . . . 105
     15.1.  Mandatory to Implement Features for All OpenID
            Providers  . . . . . . . . . . . . . . . . . . . . . . . 105
     15.2.  Mandatory to Implement Features for Dynamic OpenID
            Providers  . . . . . . . . . . . . . . . . . . . . . . . 106
     15.3.  Discovery and Registration . . . . . . . . . . . . . . . 107
     15.4.  Mandatory to Implement Features for Relying Parties  . . 107
     15.5.  Implementation Notes . . . . . . . . . . . . . . . . . . 107
       15.5.1. Authorization Code Implementation Notes . . . . . . . 107
       15.5.2. Nonce Implementation Notes  . . . . . . . . . . . . . 108
       15.5.3. Redirect URI Fragment Handling Implementation Notes . 108
     15.6.  Compatibility Notes  . . . . . . . . . . . . . . . . . . 109
     15.7.  Related Specifications and Implementer's Guides  . . . . 110
   16. Security Considerations . . . . . . . . . . . . . . . . . . . 111
     16.1.  Request Disclosure . . . . . . . . . . . . . . . . . . . 111
...

     ...
     16.2.  Server Masquerading  . . . . . . . . . . . . . . . . . . 111
     16.3.  Token Manufacture/Modification . . . . . . . . . . . . . 111
     16.4.  Access Token Disclosure  . . . . . . . . . . . . . . . . 112
     16.5.  Server Response Disclosure . . . . . . . . . . . . . . . 112
     16.6.  Server Response Repudiation  . . . . . . . . . . . . . . 112
     16.7.  Request Repudiation  . . . . . . . . . . . . . . . . . . 113
     16.8.  Access Token Redirect  . . . . . . . . . . . . . . . . . 113
     16.9.  Token Reuse  . . . . . . . . . . . . . . . . . . . . . . 113
     16.10. Eavesdropping or Leaking Authorization Codes
            (Secondary Authenticator Capture)  . . . . . . . . . . . 113
     16.11. Token Substitution . . . . . . . . . . . . . . . . . . . 113
     16.12. Timing Attack  . . . . . . . . . . . . . . . . . . . . . 115
     16.13. Other Crypto Related Attacks . . . . . . . . . . . . . . 115
     16.14. Signing and Encryption Order . . . . . . . . . . . . . . 115
     16.15. Issuer Identifier  . . . . . . . . . . . . . . . . . . . 115
     16.16. Implicit Flow Threats  . . . . . . . . . . . . . . . . . 116
     16.17. TLS Requirements . . . . . . . . . . . . . . . . . . . . 116
     16.18. Lifetimes of Access Tokens and Refresh Tokens  . . . . . 116
     16.19. Symmetric Key Entropy  . . . . . . . . . . . . . . . . . 116
     16.20. Need for Signed Requests . . . . . . . . . . . . . . . . 117
     16.21. Need for Encrypted Requests  . . . . . . . . . . . . . . 117
     16.22. HTTP 307 Redirects . . . . . . . . . . . . . . . . . . . 117
     16.23. Custom URI Schemes on iOS  . . . . . . . . . . . . . . . 117
   17. Privacy Considerations  . . . . . . . . . . . . . . . . . . . 119
     17.1.  Personally Identifiable Information  . . . . . . . . . . 119
     17.2.  Data Access Monitoring . . . . . . . . . . . . . . . . . 119
     17.3.  Correlation  . . . . . . . . . . . . . . . . . . . . . . 119
     17.4.  Offline Access . . . . . . . . . . . . . . . . . . . . . 119
   18. IANA Considerations . . . . . . . . . . . . . . . . . . . . . 121
     18.1.  JSON Web Token Claims Registration . . . . . . . . . . . 121
       18.1.1. Registry Contents . . . . . . . . . . . . . . . . . . 121
     18.2.  OAuth Parameters Registration  . . . . . . . . . . . . . 125
       18.2.1. Registry Contents . . . . . . . . . . . . . . . . . . 125
     18.3.  OAuth Extensions Error Registration  . . . . . . . . . . 127
       18.3.1. Registry Contents . . . . . . . . . . . . . . . . . . 127
     18.4.  URI Scheme Registration  . . . . . . . . . . . . . . . . 128
       18.4.1. Registry Contents . . . . . . . . . . . . . . . . . . 129
   19. References  . . . . . . . . . . . . . . . . . . . . . . . . . 130
     19.1.  Normative References . . . . . . . . . . . . . . . . . . 130
     19.2.  Informative References . . . . . . . . . . . . . . . . . 134
   Appendix A.  Authorization Examples . . . . . . . . . . . . . . . 137
     A.1.   Example using response_type=code . . . . . . . . . . . . 137
     A.2.   Example using response_type=id_token . . . . . . . . . . 138
     A.3.   Example using response_type=id_token token . . . . . . . 140
     A.4.   Example using response_type=code id_token  . . . . . . . 141
     A.5.   Example using response_type=code token . . . . . . . . . 142
     A.6.   Example using response_type=code id_token token  . . . . 142
     A.7.   RSA Key Used in Examples . . . . . . . . . . . . . . . . 143
...

   ...
   Appendix B.  Acknowledgements . . . . . . . . . . . . . . . . . . 144
   Appendix C.  Notices  . . . . . . . . . . . . . . . . . . . . . . 146
...

   ...
   o  OpenID Connect Core 1.0 incorporating errata set 1
      [OpenID.Core.Errata1]

   o  OpenID Connect Core 1.0 (final) [OpenID.Core.Final]
...
1.2.  Terminology
   ...
   "Redirection URI", "Refresh Token", "Resource Server", "Response
   Type", and "Token Endpoint" defined by OAuth 2.0 [RFC6749], the terms
   "Claim Name", "Claim Value", "JSON Web Token (JWT)", "JWT Claims
   Set", and "Nested JWT" defined by JSON Web Token (JWT) [JWT], the
   terms "Base64url Encoding", "Header Parameter", and "JOSE Header"
   defined by JSON Web Signature (JWS) [JWS], the term "User Agent"
   defined by RFC 7230 [RFC7230], and the term "Response Mode" defined
...
3.1.2.1.  Authentication Request
   ...
   "POST" methods defined in RFC 7231 [RFC7231] at the Authorization
...

   ...
   redirect_uri
      ...
      the use of "http" Redirection URIs in this case.  Also, if the
      Client is a native application, it MAY use the "http" scheme with
      "localhost" or the IP loopback literals "127.0.0.1" or "[::1]" as
      the hostname.  The Redirection URI MAY use an alternate scheme,
...

   ...
   max_age
      ...
      "auth_time" Claim Value.  Note that "max_age=0" is equivalent to
      "prompt=login".
   ...
   id_token_hint
      ...
      by the ID Token is already logged in or is logged in as a result
      of the request (with the OP possibly evaluating other information
      beyond the ID Token in this decision), then the Authorization
      Server returns a positive response; otherwise, it MUST return an
      error, such as "login_required".  When possible, an
...
3.1.2.2.  Authentication Request Validation
   ...
   5.  When an "id_token_hint" is present, the OP MUST validate that it
       was the issuer of the ID Token.  The OP SHOULD accept ID Tokens
       when the RP identified by the ID Token has a current session or
       had a recent session at the OP, even when the "exp" time has
       passed.
...
3.1.2.6.  Authentication Error Response
   ...
   parameters.  Other parameters SHOULD NOT be returned.  If the
   Redirection URI is invalid, the Authorization Server MUST NOT
   redirect the User Agent to the invalid Redirection URI.

   If the Response Mode value is not supported, the Authorization Server
   returns an HTTP response code of 400 (Bad Request) without Error
...

   ...
   Response parameters, since understanding the Response Mode is
...
3.1.3.3.  Successful Token Response
   ...
   outside the scope of this specification.  Note that the "token_type"
...

   ...
   8.   If the JWT "alg" Header Parameter uses a MAC based algorithm
        ...
        [RFC3629] representation of the "client_secret" corresponding to
        the "client_id" contained in the "aud" (audience) Claim are used
        as the key to validate the signature.  For MAC based algorithms,
        the behavior is unspecified if the "aud" is multi-valued.
...

   ...
   Section 4.2.2.1 of OAuth 2.0 [RFC6749] and OAuth 2.0 Multiple
   Response Type Encoding Practices [OAuth.Responses], unless a
   different Response Mode was specified.
...

   ...
   nonce
      REQUIRED if the Response Type of the request is "code id_token" or
      ...
      Request to the ID Token.  Sufficient entropy MUST be present in
...
4.  Initiating Login from a Third Party
   ...
   OP.  Note that this login initiation endpoint can be a different page
   at the RP than the RP's default landing page.  RPs supporting OpenID
   Connect Dynamic Client Registration 1.0 [OpenID.Registration]
   register this endpoint value using the "initiate_login_uri"
   ...
   login_hint
      OPTIONAL.  Hint to the Authorization Server about the End-User to
      be authenticated.  The meaning of this string-valued parameter is
      left to the OP's discretion.  In common use cases, the value will
      contain an e-mail address, phone number, or username collected by
      the RP before requesting authentication at the OP.  For example,
      this hint can be used by an RP after it asks the End-User for
      their e-mail address (or other identifier), passing that
      identifier as a hint to the OpenID Provider.  It is RECOMMENDED
      that the hint value match the value provided for discovery.  Other
      uses MAY include using the "sub" claim from the ID Token as the
      hint value or potentially other kinds of information about the
...
5.3.  UserInfo Endpoint
   ...
   "POST" methods defined in RFC 7231 [RFC7231].
...

   ...
   request specific combinations of Claims that cannot be specified
   using scope values.
...

         ...
         is to be used when requesting that Claim.  An equality
         comparison is used to determine whether the requested Claim
         value matches.

         When the Claim value does not match the requested value, the
         Claim is not included in the response.  If the Claim was "sub",
         a mismatch MUST cause the authentication to fail, as described
         in Section 3.1.2.2.
     ...
     "acr": {"essential": true,
         ...
         qualifier is to be used when requesting that Claim.  An
         equality comparison is used to determine whether the requested
         Claim values match.

         When the Claim value does not match any of the requested
         values, the Claim is not included in the response.
...
5.5.1.1.  Requesting the "acr" Claim
   ...
   Token with a "value" or "values" parameter requesting specific
   Authentication Context Class Reference values and the implementation
   supports the "claims" parameter, the Authorization Server MUST return
   an "acr" Claim Value that matches one of the requested values.  The
...

   ...
   and script that it does not have, any versions of those Claims
   returned that do not use the requested language and script SHOULD use
...
5.6.2.  Aggregated and Distributed Claims
   ...
   _claim_names
      ...
      which the actual Claim Values can be retrieved.  The OP MAY omit
      some Claims available from referenced Claims Providers from the
      set of Claim Names.
...

         ...
         Since it is not an error condition to not return a requested
         Claim, RPs MUST be prepared to handle the condition that some
         Claims listed in "_claim_sources" are not returned from the
         Claims Provider.  They SHOULD treat this the same as when any
         other requested Claim is not returned.
   ...
   An "iss" (issuer) Claim SHOULD be included in any JWT issued by a
   Claims Provider so that the Claims Provider's keys can be retrieved
   for signature validation of the JWT.  The value of the Claim is the
...
5.6.2.1.  Example of Aggregated Claims
   ...
   Claims Provider A. (The example also includes the Claims Provider's
...
5.6.2.2.  Example of Distributed Claims
   ...
   Provider B (Jane Doe's bank).  (The example also includes the Claims
   Provider's Issuer Identifier URL.)
...

   ...
   Provider C (a credit agency).  (The example also includes the Claims
   Provider's Issuer Identifier URL.)
   ...
   Note that not returning "phone_number", which is held by Claims
...
5.7.  Claim Stability and Uniqueness
   ...
   identifier for the End-User, since the "sub" Claim MUST be locally
   unique and never reassigned within the Issuer for a particular End-
...

   ...
   User, as described in Section 2.  Therefore, the only guaranteed
   unique identifier for a given End-User is the combination of the
   ...
   Therefore, other Claims such as "email", "phone_number",
   "preferred_username", and "name" MUST NOT be used as unique
   identifiers for the End-User, whether obtained from the ID Token or
...
6.  Passing Request Parameters as JWTs
   ...
   request_uri
      ...
      value is a URL referencing a resource containing a Request Object
      value, which is a JWT containing the request parameters.  This URL
      MUST use the "https" scheme unless the target Request Object is
   ...
   Note that the Request Objects defined here are compatible with those
   specified by The OAuth 2.0 Authorization Framework: JWT-Secured
   Authorization Request (JAR) [RFC9101].
...

   ...
   The Request Object MAY be signed or unsigned (unsecured).  When it is
   unsecured, this is indicated by use of the "none" algorithm [JWA] in
...
6.3.1.  Encrypted Request Object
   ...
   signed or unsigned (unsecured) Request Object.  In the former case,
...
7.3.  Self-Issued OpenID Provider Request
   ...
   id_token_hint
      ...
      Section 3.1.2.  Encrypting content to Self-Issued OPs is not
      supported.
   ...
   request
      OPTIONAL.  Request Object value, as specified in Section 6.1.
...
7.5.  Self-Issued ID Token Validation
   ...
   8.  A "nonce" Claim MUST be present and its value checked to verify
       that it is the same value as the one that was sent in the
       Authentication Request.  The Client SHOULD check the "nonce"
       value for replay attacks.  The precise method for detecting
       replay attacks is Client specific.
...
8.  Subject Identifier Types
   ...
   The OpenID Provider's Discovery document MUST list its supported
...
8.1.  Pairwise Identifier Algorithm
   ...
   without having to re-register all of their users.
...
10.  Signatures and Encryption
   ...
   its Discovery document or may supply this information by other means.
   The RP declares its required signing and encryption algorithms in its
   Dynamic Registration request or may communicate this information by
   other means.
...

   ...
   Symmetric Encryption
      ...
      value by using the left-most bits of a truncated SHA-2 hash of the
      octets of the UTF-8 representation of the "client_secret".  For
      keys of 256 or fewer bits, SHA-256 is used; for keys of 257-384
      bits, SHA-384 is used; for keys of 385-512 bits, SHA-512 is used.
      The hash value MUST be truncated retaining the left-most bits to
      the appropriate bit length for the AES key wrapping or direct
      encryption algorithm used, for instance, truncating the SHA-256
      hash to 128 bits for "A128KW".  If a symmetric key with greater
      than 512 bits is needed, a different method of deriving the key
      from the "client_secret" would have to be defined by an extension.
      Symmetric encryption MUST NOT be used by public (non-confidential)
...
10.2.1.  Rotation of Asymmetric Encryption Keys
   ...
   defined in RFC 7234 [RFC7234], which enables the encrypting party to
...
11.  Offline Access
   ...
   o  MUST explicitly receive or have consent for offline access when
      the registered "application_type" is "web",

   o  SHOULD explicitly receive or have consent for offline access when
      the registered "application_type" is "native".
...

   ...
   o  if the implementation is using extensions (which are beyond the
      scope of this specification) that result in the "azp" (authorized
      party) Claim being present, those extensions might specify that
      its "azp" Claim Value MUST be the same as in the ID Token issued
      when the original authentication occurred; likewise, they might
      specify that if no "azp" Claim was present in the original ID
      Token, one MUST NOT be present in the new ID Token,

   o  it SHOULD NOT have a "nonce" Claim, even when the ID Token issued
      at the time of the original authentication contained "nonce";
      however, if it is present, its value MUST be the same as in the ID
...
15.2.  Mandatory to Implement Features for Dynamic OpenID Providers
   ...
   Request URI
      ...
      "request_uri" parameter, as defined in Section 6.2.
...
15.5.2.  Nonce Implementation Notes
   ...
   JavaScript Clients and other Browser-Based Clients is to store the
...
15.7.  Related Specifications and Implementer's Guides
   ...
   o  OpenID Connect RP-Initiated Logout 1.0 [OpenID.RPInitiated] -
      Defines how a Relying Party requests that an OpenID Provider log
      out the End-User

   o  OpenID Connect Session Management 1.0 [OpenID.Session] - Defines
      how to manage OpenID Connect sessions, including postMessage-based
      logout and RP-initiated logout functionality

   o  OpenID Connect Front-Channel Logout 1.0 [OpenID.FrontChannel] -
      Defines a front-channel logout mechanism that does not use an OP
      iframe on RP pages

   o  OpenID Connect Back-Channel Logout 1.0 [OpenID.BackChannel] -
      Defines a logout mechanism that uses direct back-channel
...
16.7.  Request Repudiation
   ...
   verify that it was issued by a legitimate Client and its integrity is
   intact.
...

   ...
   (audience), "at_hash" (access token hash), and "c_hash" (code hash).
   Using the ID Token, the Client is capable of detecting the Token
   Substitution Attack.
...
16.22.  HTTP 307 Redirects
   ...
   HTTP 307 redirects send a POST request to the party being redirected
   to that contains all the form data from the previous request.  This
   can leak credentials intended for the OpenID Provider to the Relying
   Party.  Therefore, HTTP 307 redirects MUST NOT be used when
   redirecting to the Redirection URI.  Likewise, while HTTP 302
   redirects are typically implemented in a way that does not do this,
   the use of HTTP 303 redirect is preferable, as it is defined not to
   do this.

16.23.  Custom URI Schemes on iOS

   Note that on iOS, multiple applications can register as handlers for
   a custom URI scheme, therefore it is not deterministic that the
   calling application will receive the Authentication Reply from the
   Self-Issued OpenID Provider.  Use of a claimed URI is an alternative
   to using the "openid:" custom URI scheme.

   While it is possible to assign handlers to custom URI schemes and it
   is possible that the operating system could help the End-User select
...

   ...
   the correct handler, it is not possible to guarantee that the handler
   for a given custom URI scheme has not been replaced by a subsequently
   installed native application.  At the time of this writing, there
   appears to be no fool-proof mitigation for this vulnerability.
...

   ...
   o  Change Controller: OpenID Foundation Artifact Binding Working
      Group - openid-specs-ab@lists.openid.net
   o  Specification Document(s): Section 3.3.2.11 of this specification
   ...
   o  Change Controller: OpenID Foundation Artifact Binding Working
      Group - openid-specs-ab@lists.openid.net
   o  Specification Document(s): Section 7.4 of this specification

   o  Claim Name: "_claim_names"
   o  Claim Description: JSON object whose member names are the Claim
      Names for the Aggregated and Distributed Claims
   o  Change Controller: OpenID Foundation Artifact Binding Working
      Group - openid-specs-ab@lists.openid.net
   o  Specification Document(s): Section 5.6.2 of this specification

   o  Claim Name: "_claim_sources"
   o  Claim Description: JSON object whose member names are referenced
...

   ...
   o  Change controller: OpenID Foundation Artifact Binding Working
      Group - openid-specs-ab@lists.openid.net
   o  Specification document(s): Section 5.5 of this specification
   o  Related information: None
   ...
   o  Change controller: OpenID Foundation Artifact Binding Working
      Group - openid-specs-ab@lists.openid.net
   o  Specification document(s): Section 7.2.1 of this specification
   o  Related information: None
...

   ...
   o  Change controller: OpenID Foundation Artifact Binding Working
      Group - openid-specs-ab@lists.openid.net
   o  Specification document(s): Section 3.1.3.3 of this specification
   o  Related information: None
...
18.3.1.  Registry Contents
   ...
   o  Change controller: OpenID Foundation Artifact Binding Working
      Group - openid-specs-ab@lists.openid.net
   o  Specification document(s): Section 3.1.2.6 of this specification
...
18.4.  URI Scheme Registration
   ...
   [IANA.URISchemes] established by RFC 7595 [RFC7595].
...
18.4.1.  Registry Contents
   ...
   o  Scheme name: "openid"
   o  Status: Permanent
   o  Applications/protocols that use this scheme name: OpenID Connect
   o  Contact: Michael B. Jones - michael_b_jones@hotmail.com
   o  Change controller: OpenID Foundation Artifact Binding Working
      Group - openid-specs-ab@lists.openid.net
   o  References: Section 7.3 of this specification
...
19.1.  Normative References
   ...
   [CORS]     Opera Software ASA, "Cross-Origin Resource Sharing",
              July 2010, <http://www.w3.org/TR/access-control/>.
...
19.2.  Informative References
   ...
   [OAuth.Post]
              ...
              Mode", April 2015, <https://openid.net/specs/
   ...
   [OpenID.BackChannel]
              ...
              Logout 1.0", December 2023, <https://openid.net/specs/
...

              ...
              errata set 1", November 2014, <https://openid.net/specs/
              openid-connect-core-1_0-errata1.html>.

   [OpenID.Core.Final]
              Sakimura, N., Bradley, J., Jones, M., de Medeiros, B., and
              C. Mortimore, "OpenID Connect Core 1.0 (final)",
              February 2014, <https://openid.net/specs/
              openid-connect-core-1_0-final.html>.
   ...
   [OpenID.Implicit]
              ...
              Implementer's Guide 1.0", December 2023, <https://
   ...
   [OpenID.PAPE]
              ...
              Policy Extension 1.0", December 2008, <https://openid.net/
              specs/
...

   ...
   [X.1252]   International Telecommunication Union, "ITU-T
              ...
              definitions", ITU-T X.1252, April 2010, <https://
              www.itu.int/SG-CP/example_docs/ITU-T-REC/ITU-T-REC_E.pdf>.
...
A.2.  Example using response_type=id_token
   ...
   JWT, in this case "RS256", representing RSASSA-PKCS1-v1_5 using SHA-
...
Appendix B.  Acknowledgements
   ...
   people for their contributions to this specification:
      ...
      Naveen Agarwal (Naveen.Agarwal@microsoft.com), Microsoft (was at
      Google)
...

      ...
      David Recordon (recordond@gmail.com), independent (was at
      Facebook)
